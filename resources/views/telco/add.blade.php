...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <form role="form" method="POST" action="{{ route('users_add') }}">
            @csrf
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group {!! $errors->first('status','has-error') !!}">
                            <label><input type="checkbox" name="status" value="1" class="form-control" {{ (old('status') == 1) ? 'checked' : '' }}> Kích hoạt</label>
